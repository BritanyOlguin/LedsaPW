...
class ImgNosotrosController extends Controller
{
    public function bannerData()
    {
        $datosBanner = ImgNosotros::all();
        return response()->json($datosBanner);
    }

    public function bannerDataNew()
    {
        $datosBanner = ImgNosotros::oldest()->take(1)->get();
        return response()->json($datosBanner);
    }
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = ImgNosotros::find($request->id);
