...
use App\Models\cardBolsaTrabajo;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;


class CardBolsaTrabajoController extends Controller
{
    public function bannerData()
    {
        $datosBanner = CardBolsaTrabajo::all();
    ...
    public function editarBanner(Request $request)
    {
        ...
        $banner = CardBolsaTrabajo::find($request->id);
